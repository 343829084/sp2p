...
//            }
    ...
    public static List<ProductVo> findProductsBy(PageVo<ProductVo> pageVo) {
        ...
        jpql.append(" '展义保' as \"prodName\",");
        jpql.append(" '7%' as \"interestRate\",");
        jpql.append(" '40天' as \"deadline\",");
        jpql.append(" '10000.00' as \"bidMoney\",");
        jpql.append(" 'true' as \"isNewUser\",");
        jpql.append(" '500.00' as \"remainingAvailableMoney\",");
        jpql.append(" '500.00' as \"availableMoney\",");
        jpql.append(" now() as \"sellTime\",");
        jpql.append(" '30天' as \"duringTime\",");
        jpql.append(" '4天' as \"predictDeadline\",");
        jpql.append(" '1500' as \"totalBidMoney\",");
        jpql.append(" '1' as \"prodStatus\"");
        jpql.append(" from");
        jpql.append(" t_bids p");
